# Contributor License Agreement — openswmm.mcp

**Version 1.1 — August 2026**

Thank you for your interest in contributing to **openswmm.mcp**, maintained by the Technical Manager of the project (currently [@cbuahin](https://github.com/cbuahin)). This Contributor License Agreement ("CLA") clarifies the intellectual property rights granted with contributions to the project. By signing this CLA you confirm that you have the legal authority to grant these rights, and that the Technical Manager may rely on them.
...
- **"Project"** — the openswmm.mcp software repository hosted at https://github.com/HydroCouple/openswmm.mcp.
...
To submit a CCLA, open a GitHub Discussion in the **[openswmm.mcp Discussions](https://github.com/HydroCouple/openswmm.mcp/discussions)** tab with the title `[CCLA] <Organization Name>` and include:
...
- **Discussions:** [github.com/HydroCouple/openswmm.mcp/discussions](https://github.com/HydroCouple/openswmm.mcp/discussions)

---

*This CLA is maintained by the Technical Manager of openswmm.mcp (currently [@cbuahin](https://github.com/cbuahin)). Last updated: August 2026.*
